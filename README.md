...
- **Releases**: 
  - Prebuilt binaries for Linux
    - x86_64: built on Debian GNU/Linux 12 (bookworm), Flutter 3.38.7
    - aarch64: built on Debian GNU/Linux 13 (trixie), Flutter 3.38.7
  - Android: built with Flutter 3.38.7
